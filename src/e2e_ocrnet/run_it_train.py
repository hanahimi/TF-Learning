...
from util.donkey import Donkey
from e2e_ocrnet.model5_96 import Model
from e2e_ocrnet.evaluator import Evaluator

tf.app.flags.DEFINE_string('data_dir', r'D:\conda_env\workspace\py\TF-Learning\src\e2e_ocrnet\dataset\character_num_0908', 'Directory to read TFRecords files')
tf.app.flags.DEFINE_string('train_logdir', r'D:\conda_env\workspace\py\TF-Learning\src\e2e_ocrnet\logs_saic_0908', 'Directory to write training logs')
tf.app.flags.DEFINE_string('restore_checkpoint', None,'model.ckpt')
tf.app.flags.DEFINE_integer('batch_size', 32, 'Default 32')
tf.app.flags.DEFINE_float('learning_rate', 1e-2, 'Default 1e-5')
...
def train_model(path_to_train_tfrecords_file, 
                num_train_examples, 
    ...
    with tf.Graph().as_default():
        ...
        length_logtis, chars_logits = Model.inference(image_batch, drop_rate=0.5)
        loss = Model.loss(length_logtis, chars_logits, length_batch, chars_batch)
...
def main(_):
    ...
    train_model(path_to_train_tfrecords_file, 
                meta.num_train_examples,
                path_to_val_tfrecords_file, 
