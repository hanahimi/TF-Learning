...
class Model(object):
    ...
    def inference(x, drop_rate):
        ...
        h4 = hiddenlayer('hidden4', h2, 3,3,48,1,1,
                         biased=True,
                         relu=True,
                         padding=DEFAULT_PADDING,
                         dropout_rate = drop_rate,
        ...
        h10 = denselayer("hidden10", h4, num_out=768)

        char_length = denselayer("digit_length", h10, num_out=7)
        
        char00 = denselayer("digit00", h10, num_out=N_CLASSES)
        char01 = denselayer("digit01", h10, num_out=N_CLASSES)
        char02 = denselayer("digit02", h10, num_out=N_CLASSES)
        char03 = denselayer("digit03", h10, num_out=N_CLASSES)
        char04 = denselayer("digit04", h10, num_out=N_CLASSES)
        
        length_logits, chars_logits = char_length, tf.stack([char00, char01, char02, char03, char04], axis=1)
