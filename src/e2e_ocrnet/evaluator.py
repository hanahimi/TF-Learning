...
# save_path1 = r'D:\vision studio\workspace\eclipse\SVHNClassifier\src\data_temp\label.txt'
# f1 = open(save_path1,'w')
# save_path2 = r'D:\vision studio\workspace\eclipse\SVHNClassifier\src\data_temp\predict.txt'
    ...
    def evaluate(self, path_to_checkpoint, path_to_tfrecords_file, num_examples, global_step):
        ...
        with tf.Graph().as_default():
            image_batch, length_batch, digits_batch = Donkey.build_batch(path_to_tfrecords_file,
                                                                         ...
                                                                         shuffled=False)
            length_logits, digits_logits = Model.inference(image_batch, drop_rate=1.0)
...
#                     label_temp,predictions_temp= sess.run([labels_string,predictions_string])
#                     print('label: %s\ndigits: %s' % (label_temp,predictions_temp))
#                     str1 = ('%s\n'%label_temp)
#                     str2 = ('%s\n'%predictions_temp)
#                     f1.write(str1)
#                     f2.write(str2)
